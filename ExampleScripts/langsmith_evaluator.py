...
from langsmith.evaluation import EvaluationResult  # Removed run_evaluator
...
# from langchain.schema import Document # Removed Document
...
class LangSmithRAGEvaluator:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        if api_key:
            ...
            raise ValueError(
                "LangSmith API key not found. Please provide it or set LANGCHAIN_API_KEY environment variable."
            )
    ...
    def custom_groundedness_evaluator(
        ...
        # Extract data
        # query = run.inputs.get("query") # Unused variable
        ...
        # Get evaluation
        eval_response = chain.invoke({"response": response, "contexts": context_text})
