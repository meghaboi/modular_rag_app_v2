...
from core.rag_pipeline import RAGPipeline  # Corrected path
from core.embedding_models import EmbeddingModelFactory  # Corrected path
from core.vector_stores import VectorStoreFactory  # Corrected path
from core.llm_models import LLMFactory  # Corrected path

# from langsmith import Client # Removed Client as it's unused directly
...
def run_example_evaluation():
    ...
    # results = evaluator.evaluate_rag_pipeline( # Unused variable
    ...
    print(
        f"View detailed results in LangSmith: https://smith.langchain.com/projects/rag-evaluation-results"
    )
